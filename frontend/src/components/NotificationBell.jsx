      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-96 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-slate-200 dark:border-slate-700 z-50">
          ...
          <div className="p-4 border-b border-slate-200 dark:border-slate-700">
            ...
            {/* Tabs */}
            <div className="flex mt-3" style={{gap: '0.25rem'}}>
              <button
                ...
                {currentNotifications.length > 0 && (
                  <div className="px-2 py-1 mb-2">
                    <button
                      ...
                      className="w-full px-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition-colors flex items-center justify-center"
                      style={{gap: '0.5rem'}}
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center mt-2 text-xs text-slate-500 dark:text-slate-400" style={{gap: '1rem'}}>
                          ...
                          {/* Aktionen */}
                          <div className="flex items-center ml-2" style={{gap: '0.25rem'}}>
                            <button
